...
# Modified on 10/11/2022:
# Added #CAPER docker to WDL so that caper can pick it up automatically on GCP

#CAPER docker quay.io/encode-dcc/chip-seq-pipeline:v1.1.4-sambamba-0.7.1-rev1
